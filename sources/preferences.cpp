...
{
    QString dir = QFileDialog::getExistingDirectory(dialog.data(), tr("Add folder"), searchpathfrom,
...
{
    return QFileDialog::getExistingDirectory(dialog.data(), tr("Add folder"), path,
                                             QFileDialog::ShowDirsOnly | QFileDialog::DontResolveSymlinks);
}
